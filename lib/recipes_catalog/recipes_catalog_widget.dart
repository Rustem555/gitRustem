...
import 'recipes_catalog_model.dart';
export 'recipes_catalog_model.dart';

class RecipesCatalogWidget extends StatefulWidget {
  const RecipesCatalogWidget({Key? key}) : super(key: key);

  @override
  _RecipesCatalogWidgetState createState() => _RecipesCatalogWidgetState();
}

class _RecipesCatalogWidgetState extends State<RecipesCatalogWidget> {
  late RecipesCatalogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecipesCatalogModel());
  }
